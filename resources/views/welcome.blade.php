...
<body>
    ...
    <main>
                ...
                <div class="row g-4">
                    <div class="col-md-6 col-lg-4">
                        <div class="team3__box gsap-pop">
                            <div class="team-thumb">
                                <img src="assets/images/team/team-3-1.png" alt="team-member" class="w-100" />
                            </div>
                            <div class="team-content">
                                <h5 class="member-name line-clamp-1">Darlene Robertson</h5>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="team3__box gsap-pop" data-delay="0.4">
                            <div class="team-thumb">
                                <img src="assets/images/team/team-3-2.png" alt="team-member" class="w-100" />
                            </div>
                            <div class="team-content">
                                <h5 class="member-name line-clamp-1">Cody Fisher</h5>
                                <span class="member-position">Marketing Coordinator</span>
                                <div class="social-icons">
                                    <ul class="custom-ul">
                                        <li>
                                            <a href="index-4.html#">
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="team3__box gsap-pop" data-delay="0.8">
                            <div class="team-thumb">
                                <img src="assets/images/team/team-3-3.png" alt="team-member" class="w-100" />
                            </div>
                            <div class="team-content">
                                <h5 class="member-name line-clamp-1">Wade Warren</h5>
                                <span class="member-position">Medical Assistant</span>
                                <div class="social-icons">
                                    <ul class="custom-ul">
                                        <li>
                                            <a href="index-4.html#">
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="team3__box gsap-pop">
                            <div class="team-thumb">
                                <img src="assets/images/team/team-3-4.png" alt="team-member" class="w-100" />
                            </div>
                            <div class="team-content">
                                <h5 class="member-name line-clamp-1">Eleanor Pena</h5>
                                <span class="member-position">Creative Director</span>
                                <div class="social-icons">
                                    <ul class="custom-ul">
                                        <li>
                                            <a href="index-4.html#">
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="team3__box gsap-pop" data-delay="0.4">
                            <div class="team-thumb">
                                <img src="assets/images/team/team-3-5.png" alt="team-member" class="w-100" />
                            </div>
                            <div class="team-content">
                                <h5 class="member-name line-clamp-1">Arlene McCoy</h5>
                                <span class="member-position">President of Sales</span>
                                <div class="social-icons">
                                    <ul class="custom-ul">
                                        <li>
                                            <a href="index-4.html#">
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="team3__box gsap-pop" data-delay="0.8">
                            <div class="team-thumb">
                                <img src="assets/images/team/team-3-6.png" alt="team-member" class="w-100" />
                            </div>
                            <div class="team-content">
                                <h5 class="member-name line-clamp-1">Ralph Edwards</h5>
                                <span class="member-position">UWeb Designer</span>
                                <div class="social-icons">
                                    <ul class="custom-ul">
                                        <li>
                                            <a href="index-4.html#">
        ...
        <!-- ================= Video Section Start ================= -->
        {{-- <div class="video2 section position-relative overflow-hidden bg-color-1">
            <div class="container-fluid px-0">
                <div class="row">
                    <div class="col-12">
                        <div class="video2__player-wrapper">
                            <video muted="" autoplay="" loop=""
                                src="assets/videos/home_four/video-section.mp4" class="video2-player"></video>
                        </div>
                    </div>
                </div>
            </div>

            <div class="video2__content-outer section-padding-top-bottom">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="video2__content">
                                <div class="section-header d-none d-md-block">
                                    <span class="section-sub-title no-icon">Play to watch reels</span>
                                    <h2 class="section-title">
                                        Unleash the full potential of your creativity
                                    </h2>
                                </div>
                                <div class="row-padding-top">
                                    <button class="video2-play-btn">
        ...
        {{-- <section class="pricing section bg-color-1 section-padding-top-bottom">
            <div class="container">
                <div class="row g-4 section-header justify-content-between align-items-start row-padding-bottom">
                    ...
                    <div
                        class="col-md-5 col-lg-5 d-flex justify-content-center justify-content-md-end align-items-end">
                        <div class="pricing__plan-btns">
                            <input id="price-monthly" type="radio" name="switch" checked />
                            <input id="price-yearly" type="radio" name="switch" />
                            <label for="price-monthly" class="pricing-btn active">Monthly</label>
                            <label for="price-yearly" class="pricing-btn">Yearly</label>
                ...
                <div class="row g-4">
                    <div class="col-md-6 col-xl-4">
                        <div class="pricing__box gsap-pop">
                            ...
                            <div class="pricing-body">
                                ...
                                <a class='agx-btn' href='contact-us.html'>
                                    <span>Get Started</span>
                    ...
                    <div class="col-md-6 col-xl-4">
                        <div class="pricing__box gsap-pop" data-delay="0.4">
                            <div class="pricing-header">
                    ...
                    <div class="col-md-6 col-xl-4">
                        <div class="pricing__box gsap-pop" data-delay="0.8">
                            <div class="pricing-header">
        ...
        {{-- <section class="testimonial4 section bg-color-2 section-padding-top-bottom overflow-hidden">
            <div class="container">
                <div class="row g-4 section-header justify-content-between align-items-start row-padding-bottom">
                    <div class="col-md-8 col-lg-7 col-xxl-6">
                        <h2 class="section-title move-anim">
                            Our clients positive response
                        </h2>
                    </div>
                    <div
                        class="col-md-4 col-lg-4 d-none d-md-flex justify-content-center justify-content-md-end align-items-end">
                        <img src="assets/images/testimonial/testimonial4-icon.png" alt="icon" />
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
                        <div class="testimonial4__slider-wrapper gsap-pop">
                            <div class="swiper testimonial4__content-slider">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="testimonial4__box">
                                            <div class="stars">
                                                <ul>
                                            ...
                                            <div class="testimonial-content">
                                                <h4 class="revew-content">
                                                    "1-Agenxis proficiency is the exceeded to
                                                    expectations, revolutionizing our business. Highly
                                                    endorse their are outstanding service!"
                                                </h4>

                                                <div class="authorAndNav">
                                                    <div class="author">
                                                        <h5 class="author-title">Michael Ramirez</h5>
                                                        <div class="author-position">
                                                            Marketing Manager
                                                        </div>
                                                    </div>
                                                    <div class="testimonial4__navigation">
                                                        <div class="testimonial4-prev">
                                                            <span>
                                                                <i class="fa-solid fa-arrow-left"></i>
                                                            </span>
                                                        </div>
                                                        <div class="testimonial4-next">
                                                            <span>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="testimonial4__box">
                                            ...
                                            <div class="testimonial-content">
                                                <h4 class="revew-content">
                                                    "2-Agenxis proficiency is the exceeded to
                                                    expectations, revolutionizing our business. Highly
                                                    endorse their are outstanding service!"
                                                </h4>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="testimonial4__box">
                                            ...
                                            <div class="testimonial-content">
                                                <h4 class="revew-content">
                                                    "3-Agenxis proficiency is the exceeded to
                                                    expectations, revolutionizing our business. Highly
                                                    endorse their are outstanding service!"
                                                </h4>
                            ...
                            <div class="swiper testimonial4__thumb-slider">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="testimonial4__thumb">
                                            <div class="shape">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="139" height="142"
                                                    viewBox="0 0 139 142" fill="none">
                                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                                        d="M48.8667 71L1 86.578L4.92688 98.6832L52.807 83.1336L23.2333 123.888L33.5215 131.372L63.1227 90.6327L63.1382 140.996L75.858 141L75.8736 90.6327L105.472 131.368L115.765 123.891L86.1893 83.1336L134.066 98.682L138 86.5792L90.1295 71L137.996 55.422L134.069 43.3168L86.1893 58.8664L115.758 18.1188L115.763 18.1123L105.475 10.6285L75.8736 51.3673L75.858 1.00394L63.1382 1L63.1227 51.3673L33.5238 10.6316L23.231 18.1092L52.807 58.8664L4.93279 43.3187L1 55.422L48.8667 71Z"
                                                        stroke="currentColor" />
                                                </svg>
                                            </div>
                                            <img src="assets/images/testimonial/testimonial4-thumb-1.png"
                                                alt="testimonial4-thumb" class="w-100" />
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="testimonial4__thumb">
                                            ...
                                            <img src="assets/images/testimonial/testimonial4-thumb-2.png"
                                                alt="testimonial4-thumb" class="w-100" />
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="testimonial4__thumb">
                                            ...
                                            <img src="assets/images/testimonial/testimonial4-thumb-3.png"
                                                alt="testimonial4-thumb" class="w-100" />
                                        </div>
                                    </div>
                                </div>
        ...
        <!-- ================= Blog Section Start ================= -->
        {{-- <section class="blog4 section bg-color-1 section-padding-top-bottom">
            <div class="container">
                <div class="row g-4 section-header align-items-end row-padding-bottom">
                    <div class="col-md-8 col-lg-8">
                        <h2 class="section-title move-anim">
                            Your business with professionals
                        </h2>
                    ...
                    <div
                        class="col-md-4 col-lg-4 d-flex justify-content-center justify-content-md-end align-items-end">
                        <a class='agx-btn v5' href='blog.html'>
                            <span>Explore All</span>
                            <span>
                                <i class="fa-regular fa-arrow-up-right"></i>
                                <i class="fa-regular fa-arrow-up-right"></i>
                ...
                <div class="row g-4">
                    <div class="col-md-6 col-lg-4">
                        <div class="blog-box4 gsap-pop">
                            <div class="blog-thumb">
                                <img src="assets/images/blog/blog-thumb-4-1.png" alt="blog-thumb" class="w-100" />
                                <a class='blog-link' href='blog-details.html'></a>
                            </div>
                            <div class="blog-content">
                                <div class="blog-meta">
                                    <ul>
                                        <li>
                                            <a class='post-date' href='blog-details.html'>
                                                October 19, 2024
                                            </a>
                                        </li>
                                        <li>
                                            <a class='post-comment' href='blog-details.html'>
                                                Comment
                                            </a>
                                        </li>
                                    </ul>
                                ...
                                <h5 class="blog-title line-clamp-2">
                                    <a href='blog-details.html'>Strategic insights challenges lasting success</a>
                                </h5>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-4">
                        <div class="blog-box4 gsap-pop" data-delay="0.4">
                            <div class="blog-thumb">
                                <img src="assets/images/blog/blog-thumb-4-2.png" alt="blog-thumb" class="w-100" />
                                <a class='blog-link' href='blog-details.html'></a>
                            </div>
                            <div class="blog-content">
                                <div class="blog-meta">
                                ...
                                <h5 class="blog-title line-clamp-2">
                                    <a href='blog-details.html'>Transforming Challenges into Opportunities</a>
                                </h5>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-4">
                        <div class="blog-box4 gsap-pop" data-delay="0.8">
                            <div class="blog-thumb">
                                <img src="assets/images/blog/blog-thumb-4-3.png" alt="blog-thumb" class="w-100" />
                                <a class='blog-link' href='blog-details.html'></a>
                            </div>
                            <div class="blog-content">
                                <div class="blog-meta">
                                ...
                                <h5 class="blog-title line-clamp-2">
                                    <a href='blog-details.html'>Building Stronger Opportunity Businesses Together</a>
                                </h5>
                            </div>
                        </div>
                    </div>
